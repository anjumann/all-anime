...
const Details = () => {
    ...
    return (
        <>
            {loading ? (<div className='h-screen bg-[#c0eafa] flex justify-center items-center w-screen fon text-3xl' >
                    ...
                    <section className="text-gray-700 body-font overflow-hidden bg-white">
                        <div className="container px-5 py-24 mx-auto">
                            <div className="lg:w-4/5 mx-auto flex justify-between flex-wrap ">
                                <img alt={anime.animeTitle} className="md:w-4/12 mx-auto w-full object-cover object-center rounded border border-gray-200 justify-center" src={anime.animeImg} />
